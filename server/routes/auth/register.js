import { createPendingAccount, enforceRateLimit, validateRegistration } from '../../../api/_lib/auth.js'
import { assertSameOrigin, functionHandler, json, readJson, requireMethod } from '../../../api/_lib/http.js'
