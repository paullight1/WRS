import { updateAuthoritativeSettings } from '../../../api/_lib/account.js'
...
export default functionHandler(async (request) => {
  ...
  if (!/^[a-z]{2}(-[A-Z]{2})?$/.test(input.language))
    throw new HttpError(400, 'Language code is invalid.', 'invalid-language')
  ...
  if (!input.timezone || input.timezone.length > 100)
    throw new HttpError(400, 'Timezone is invalid.', 'invalid-timezone')
