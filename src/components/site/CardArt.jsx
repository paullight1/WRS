...
const text = (a) => (
  <>
    ...
    {[0, 1, 2, 3].map((i) => (
      <path key={i} d={`M188 ${62 + i * 26}h${i === 3 ? 52 : 70}`} {...S} strokeWidth="5" stroke={a} opacity={1 - i * 0.15} />
    ))}
...
const conversation = (a) => (
  <>
    <path d="M58 50h122a14 14 0 0 1 14 14v40a14 14 0 0 1-14 14H96l-24 20v-20h-14a14 14 0 0 1-14-14V64a14 14 0 0 1 14-14z" {...S} />
    <path d="M142 106h120a14 14 0 0 1 14 14v34a14 14 0 0 1-14 14h-84l-22 18v-18h-14a14 14 0 0 1-14-14v-34a14 14 0 0 1 14-14z" {...S} stroke={a} />
