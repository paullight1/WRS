...
export const rewardWays = [
  ...
  {
    icon: 'model_training',
    label: 'Complete AI Training',
    desc: 'Finish a training module',
    xp: 300,
    tone: 'tertiary',
  },
...
export const boosts = [
  {
    ...
    type: 'Temporary',
    cost: 400,
    desc: '+15% task throughput for 24h',
    tone: 'primary',
  },
  {
    icon: 'dataset',
    label: 'Data Task Limit',
    type: 'Temporary',
    cost: 350,
    desc: '+10 daily tasks for 48h',
    tone: 'tertiary',
  },
  {
    icon: 'psychology',
    ...
    type: 'Permanent',
    cost: 1200,
    desc: 'Training completes 20% faster',
    tone: 'secondary',
  },
  {
    icon: 'memory',
  ...
  },
  {
    ...
    type: 'Temporary',
    cost: 900,
    desc: 'Front of the queue for 7 days',
    tone: 'secondary',
  },
]
...
export const marketplaceItems = [
  ...
  {
    id: 'warehouse',
    name: 'Warehouse Ops Module',
    dev: 'NorthChain',
    price: 34,
    rating: 4.7,
    reviews: 810,
    cat: 'Industry Modules',
    icon: 'inventory_2',
    accent: 'blue',
    requires: 'Professional',
    size: '140 MB',
...
export const courses = [
  {
    title: 'Neural Interface Calibration III',
    level: 'Expert',
    duration: '9h 20m',
    xp: 300,
    progress: 72,
...
export const communityEvents = [
  ...
  {
    title: 'Global Annotation Challenge',
    when: 'Fri · 12:00 UTC',
    type: 'Challenge',
    attendees: 1290,
    icon: 'emoji_events',
...
export const notifications = [
  {
    cat: 'Robot Activity',
    text: 'Your robot has completed 24 tasks.',
    time: '10m',
    icon: 'smart_toy',
    tone: 'primary',
    unread: true,
  ...
  {
    cat: 'Data Task',
    text: 'Your voice dataset has been approved.',
    time: '1h',
    icon: 'verified',
    tone: 'tertiary',
    unread: true,
  ...
  {
    cat: 'Deployment',
    text: 'Your deployment request was accepted.',
    time: '3h',
    icon: 'rocket_launch',
    tone: 'secondary',
    unread: true,
  ...
  {
    cat: 'Earnings',
    text: 'Your event code reward has been added.',
    time: '6h',
    icon: 'workspace_premium',
    tone: 'primary',
    unread: false,
  ...
  {
    cat: 'Community Event',
    text: 'A new language training mission is available.',
    time: '1d',
    icon: 'translate',
    tone: 'tertiary',
    unread: false,
  ...
  {
    cat: 'Wallet',
    text: 'Your withdrawal request is being reviewed.',
    time: '2d',
...
export const paymentMethods = [
  ...
  {
    id: 'wallet',
    label: 'WRS Wallet Balance',
    desc: 'Available: $184.20',
    icon: 'account_balance_wallet',
    from: '#a78bfa',
    to: '#6d28d9',
  },
