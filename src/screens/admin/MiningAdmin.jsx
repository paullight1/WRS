...
export default function MiningAdmin() {
  ...
  if (denied) return <section className="mx-auto flex min-h-[60vh] max-w-xl items-center px-4 py-12"><Card accent="#dc3a3f" className="w-full p-7 text-center"><span className="mx-auto grid h-14 w-14 place-items-center rounded-2xl bg-error/15 text-error"><Icon name="admin_panel_settings" size={28} /></span><h1 className="mt-4 font-headline-lg text-headline-lg text-on-surface">Mining administration is restricted</h1><p className="mt-2 text-body-md text-on-surface-variant">This control plane requires a trusted platform or tenant administrator role. Member accounts cannot review payouts or change conversion rates.</p><Button className="mt-6" variant="ghost" onClick={load}>Try again</Button></Card></section>

  return (
    <section className="mx-auto w-full max-w-[1500px] space-y-5 px-4 py-5 sm:px-6 lg:px-8">
